...
<form action="{{ route('surat.preview', ['jenis' => $jenis]) }}" method="POST" class="space-y-6">
  ...
  <div class="bg-gray-50 rounded-xl p-8 mb-8">
    ...
    <div class="space-y-4">
      ...
      <div>
        ...
        <input type="text" name="nik_pemohon" value="{{ $penduduk->nik ?? '' }}" placeholder="Masukkan NIK" class="w-full h-12 border border-gray-300 rounded-lg shadow-sm px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required />
      </div>
  ...
  <div class="bg-gray-50 rounded-xl p-8 mb-8">
    ...
    <div class="space-y-4">
      ...
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-1">NIK</label>
        <input type="text" name="nik_ayah" placeholder="Masukkan NIK" class="w-full h-12 border border-gray-300 rounded-lg shadow-sm px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required />
      </div>
  ...
  <div class="bg-gray-50 rounded-xl p-8 mb-8">
    ...
    <div class="space-y-4">
      ...
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-1">NIK</label>
        <input type="text" name="nik_ibu" placeholder="Masukkan NIK" class="w-full h-12 border border-gray-300 rounded-lg shadow-sm px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required />
      </div>
